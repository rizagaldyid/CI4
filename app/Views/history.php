        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- card header -->
                    <div class="card-body">
                    <h6><button type="button" class="btn btn-success pull-left" id="ButtonParkir" data-attr="<?=site_url('limbah/new')?>" data-toggle="modal" data-target="#ParkirModal"><b class="fa fa-fw fa-save"></b>Export</button></h6>
...
<script>
    ...
    $(document).ready(function(){
        $(document).on('click', '#ButtonDelMove',function(event){
            event.preventDefault();
            let href=$(this).attr('data-attr');
            Swal.fire({
                title: 'Apakah Anda Yakin?',
